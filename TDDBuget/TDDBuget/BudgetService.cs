...
public class BudgetService
{
    ...
    public decimal Query(DateTime start, DateTime end)
    {
        ...
        if (start.Month == end.Month)
        {
            ...
            {
                var result = budgetData.Where(x => x.YearMonth == start.ToString("yyyyMM")).FirstOrDefault(defaultBudget);
        ...
        var startBudget = budgetData.Where(x => x.YearMonth == start.ToString("yyyyMM")).FirstOrDefault(defaultBudget);
        var endBudget = budgetData.Where(x => x.YearMonth == end.ToString("yyyyMM")).FirstOrDefault(defaultBudget);
